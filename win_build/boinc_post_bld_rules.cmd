...
if not exist %OUTPUTDIR%\libcurld.dll (
    ...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\curl\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\libcurld.dll" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\libcurl.dll (
    echo Copying libcurl to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\curl\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\libcurl.dll" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\ca-bundle.crt (
    echo Copying ca-bundle.crt to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\curl\ca-bundle.crt" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\libeay32.dll (
    echo Copying libeay32 to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\openssl\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\libeay32.dll" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\ssleay32.dll (
    echo Copying ssleay32 to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\openssl\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\ssleay32.dll" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\zlib1d.dll (
    echo Copying zlib1d to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\zlib\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\zlib1d.dll" "%OUTPUTDIR%"
)

if not exist %OUTPUTDIR%\zlib1.dll (
    echo Copying zlib1 to the output directory...
    copy "%PROJECTROOTDIR%\..\synecdoche_depends_win_vs2005\zlib\mswin\%PLATFORMNAME%\%CONFIGNAME%\bin\zlib1.dll" "%OUTPUTDIR%"
)
